...
Built for the [Elasticsearch Agent Builder Hackathon](https://www.elastic.co/) (Jan 22 – Feb 27, 2026).
...
QuantumState monitors four services from a fictional e-commerce platform:

| Service | What it does |
|---|---|
| **payment-service** | Processes credit card charges and refunds |
| **checkout-service** | Handles cart → order placement flow |
| **auth-service** | Authenticates users via JWT + Redis session cache |
| **inventory-service** | Tracks stock levels across EU warehouse |
